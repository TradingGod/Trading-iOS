...
class SecondaryChartRenderer: BaseChartRenderer {
    ...
    var state: TGSecondaryState = .none

    init(maxValue: CGFloat, minValue: CGFloat, chartRect: CGRect, candleWidth: CGFloat, topPadding: CGFloat, state:TGSecondaryState ) {
    ...
    func drawMACD(context: CGContext, lastPoint: TGKLineModel?, curPoint: TGKLineModel, curX: CGFloat) {
